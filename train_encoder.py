...
if __name__ == "__main__":
    ...
    for j in range(file_number, file_number+4):
        ...
        filepath = 'C:/Users/Mark/OneDrive - The University of Texas at Austin/Documents/HCRL/LAFAN1_VAE_Experiment/LAFAN1_Retargeting_Dataset/g1/generated/model_' + str(len(motions)) + '_files_' + str(epochs) + '_epochs.csv'
        error_filepath = 'C:/Users/Mark/OneDrive - The University of Texas at Austin/Documents/HCRL/LAFAN1_VAE_Experiment/LAFAN1_Retargeting_Dataset/g1/generated/error_' + str(len(motions)) + '_files_' + str(epochs) + '_epochs.csv'
